...
NUMBER_RAXS_SPECTRA=12#total number of RAXR spectra
...
##<setting slabs>##
wal=0.82657#wavelength,set this number right each time (read it from nQc data file)
c_lattice=20.1328#correct c each time (use q-corrected c),c_lattice=c_projected/sin(180-beta)
